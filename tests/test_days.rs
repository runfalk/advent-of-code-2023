...
fn test_day13() -> Result<()> {
    assert_eq!(
        run_day(13, advent_of_code_2023::day13::main)?,
        (41859, Some(30842)),
    );
    Ok(())
}
...
fn test_day14() -> Result<()> {
    assert_eq!(
        run_day(14, advent_of_code_2023::day14::main)?,
        (108918, Some(100310)),
    );
    Ok(())
}
...
fn test_day15() -> Result<()> {
    assert_eq!(
        run_day(15, advent_of_code_2023::day15::main)?,
        (516070, Some(244981)),
    );
    Ok(())
}
...
fn test_day16() -> Result<()> {
    assert_eq!(
        run_day(16, advent_of_code_2023::day16::main)?,
        (8539, Some(8674)),
    );
    Ok(())
}
